...
const AboutContent: React.FC = () => {
  return (
    <>
        ...
        <Container>
          <div className="w-full flex flex-col">
            ...
            <div className="w-full sm:w-[50%] flex flex-col gap-4">
              ...
              <p className="text-xl font-normal  leading-relaxed text-[#F5F4F6]">
      ...
      <div className="bg-[#111113] text-white py-[152px]">
        <Container>
          <div className="w-full flex flex-col gap-20">
            <div className="w-full flex flex-col gap-4">
              ...
              <p className="text-xl font-normal text-[#F5F4F6]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Card 1 */}
              <div className="flex flex-col gap-4 bg-[#212227] rounded-md py-10 px-8">
                <div>
                  {' '}
                  <img
                    src={'/images/about/User-Hand-Up.svg'}
                    alt="Hand-Up"
                  />{' '}
                </div>
        ...
        <div className="w-full md:h-[548px] flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-[55%] flex flex-col gap-8 items-start justify-center">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xl text-[#464853] font-normal">
          ...
          <div className="w-full md:w-[45%] h-full max-h-[548px] flex flex-row relative">
