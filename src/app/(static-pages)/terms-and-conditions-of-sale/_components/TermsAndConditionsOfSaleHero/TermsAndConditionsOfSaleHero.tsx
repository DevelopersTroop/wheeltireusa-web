...
const TermsAndConditionsOfSaleHero = () => {
  return (
      ...
      <Container>
        <div className="relative z-10 flex flex-col gap-3 sm:gap-5 justify-center py-10 sm:py-20 px-4">
          ...
          <p className="text-gray-300 text-base sm:text-lg max-w-xl leading-relaxed">
            The terms that govern every purchase made through WheelTireUSA — from order acceptance to dispute resolution.
          </p>
...
export default TermsAndConditionsOfSaleHero;
