...
// Component to render the hero section for the  Become and installer page
const BecomeAnInstallerHero = () => {
  return (
        ...
        <div className="flex flex-col gap-2 sm:gap-6 justify-center -top-[11px] items-start self-stretch relative h-[150px] sm:h-[280px]">
          ...
          <h5 className="text-xl text-white">
            <span className="text-white text-base sm:text-xl font-normal [text-shadow:2px_2px_4px_black]">
              Partner with us to expand your business and reach more customers.
            </span>
          </h5>
        </div>
      </Container>
...
export default BecomeAnInstallerHero;
