      ...
      <div className="flex flex-col gap-[10px] items-start justify-center w-full mt-[10px] mb-10 md:mb-20">
        <div className="flex flex-col gap-[10px] items-start justify-center w-full">
          ...
          <p>
            ...
            at Tirematic, we’re proud to support the brave men and women in our
            armed forces. Our Military Discount program is a small token of
            appreciation for active duty members and veterans. We believe
          ...
          <div className="flex flex-col gap-2 items-start justify-center w-full">
            ...
            <p>
              ...
              gratitude, ensuring you get a great deal on safe, reliable tires.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 items-start justify-center w-full">
            ...
            <ul className="list-disc pl-5">
              <li>
                ...
                You’ll be guided through a quick verification (we partner with a
                trusted service to instantly confirm your military status,
          ...
          <div className="flex flex-col gap-2 items-start justify-center w-full">
            ...
            <ul className="list-disc pl-5">
              <li>
                Our military discount can be combined with most other promotions
                and rebates for even bigger savings. (Stack that savings
                whenever possible!)
              </li>
              <li>
                {' '}
              ...
              <li>
                ...
                just a call or chat away to assist. We’re here to make it easy.
              </li>
            </ul>
          </div>

          <p>
            On behalf of the entire Tirematic team: Thank you for your service!
            We’re honored to help you stay safe on the road, and this is one way
            we give back. If you have questions about eligibility or the
...
export default MilitaryDiscountContent;
