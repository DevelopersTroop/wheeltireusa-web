    ...
    <Container>
      ...
      <div className="flex flex-col gap-[10px] items-start justify-center w-full mt-[10px] mb-10 md:mb-20">
        <div className="flex flex-col gap-[10px] items-start justify-center w-full">
          <h2 className="text-3xl font-semibold text-btext">Blog Resources</h2>
          ...
          <p>
            ...
            out of your driving experience. Check back regularly for new updates
...
export default BlogResourcesContent;
