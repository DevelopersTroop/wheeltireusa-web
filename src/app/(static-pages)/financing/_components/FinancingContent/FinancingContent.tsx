...
import { FinancingMobile } from './components/FinancingMobile';
    ...
    <div className="w-full flex flex-col gap-8 pt-6 pb-20 sm:pb-40">
      ...
      <div className="w-full flex flex-col gap-4 text-start sm:text-center">
        ...
        <p className="text-lg font-normal text-[#210203] max-w-[752px] m-auto hidden sm:block">
          Quality wheels and tires are an investment in your vehicles safety and
          performance. To make your purchase easier on your finances, we offer
          flexible payment options tailored to suit your budget. As your trusted
          source for top-brand tires at discount prices, we’re dedicated to
          making sure you dont have to compromise on quality. Select one of the
          options below during checkout to secure your financing today!
        </p>
        {/* Mobile description */}
        <p className="text-lg font-normal text-[#210203] max-w-[752px] m-auto sm:hidden">
          Quality wheels and tires are an investment in your vehicles safety and
          performance. To make your purchase easier on your finances, we offer
          flexible payment options tailored to suit your budget.{' '}
          <span className="block pt-4 ">
            {' '}
            As your trusted source for top-brand tires at discount prices, we’re
