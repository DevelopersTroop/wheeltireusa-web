// ProductCardSkeleton component to display a loading placeholder while product data is being fetched
const ProductCardSkeleton = () => {
  return (
    <div className={'border border-white rounded-xl px-2 pb-8'}>
