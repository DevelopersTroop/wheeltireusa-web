...
export const ShippingDetails: React.FC<{
    ...
    localDealerInfo: any;
}> = ({ selectedDealer, setStep, shippingAddress, selectedOptionTitle, localDealerInfo }) => {
    return (
        <div className="flex items-start gap-4 font-bold">
            ...
            <div className="flex flex-col gap-4 items-start">
                ...
                <div>
                    ...
                    ) : localDealerInfo?.name ? (
                        <div className="font-light text-gray-700">
                            <p>
                                <span className="font-bold">Name:</span> {localDealerInfo?.name}
                            </p>
                            <p>
                                <span className="font-bold">Phone:</span> {localDealerInfo?.phone}
                            </p>
                            <p>
                                <span className="font-bold">Address:</span> {localDealerInfo?.address}
                            </p>
                        </div>
                    ) : selectedDealer ? (
