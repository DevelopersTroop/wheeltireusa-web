...
export const Footer = () => {
    return (
        <div className="relative z-10 bg-black"> {/* Footer background color */}
            <footer className="container">
                <div className={"py-14 text-white"}>
                    <div
                        className={
                            "flex gap-12 flex-col justify-between lg:flex-row"
                        }
                    >
                        {/* Left Section: Logo, Social Media, and Main Menu */}
                        <div className={'flex flex-col lg:flex-row w-full lg:w-1/2 gap-x-8 gap-y-10'}>
                            <div className={"w-full lg:w-2/3 flex flex-col items-center lg:items-start justify-between"}>
                                ...
                                <div className={"mt-12 text-[rgb(188,184,184)] text-[14px] hidden lg:block"}>
                        ...
                        <div className={'w-full lg:w-1/2 flex flex-col items-center text-center lg:text-start lg:flex-row lg:items-start gap-x-8 gap-y-10'}>
                            <div className={"w-full flex flex-col gap-y-6"}>
                                <h3 className={"capitalize font-bold"}>Where it all began</h3>
                                <p className={"leading-loose"}>
                                    What began as a distribution warehouse full of passionate wheel
                                    enthusiasts, quickly evolved into the youngest multi-piece
                                    forged wheel line in the world…{" "}
                                    <Link
                                        href="/about-us"
                            ...
                            <div className={"w-full flex flex-col gap-y-6 items-center lg:items-start"}>
                                ...
                                <div className="flex flex-col gap-4">
                                    <Link className="text-white font-normal flex items-center gap-2"
                                    ...
                                    <Link className="flex gap-2 items-center font-normal text-white"
                        ...
                        <div className={"text-[rgb(188,184,184)] text-[14px] lg:hidden text-center"}>
                            <div>&copy; 2025 Amani Forged Wheels. All Rights Reserved.</div>
                            <div>
                                <Link href={"/terms-conditions"}>Terms and Conditions | </Link>
                                <Link href={"/privacy-policy"}>Privacy Policy | </Link>
