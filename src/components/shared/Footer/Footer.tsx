...
export default function Footer() {
  ...
  return (
    <>
      {/* Disclaimer */}
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-10 text-center text-gray-500">
        <p className="mt-10 text-justify text-xs sm:text-sm leading-relaxed">
          FORD, FORD F-150 & F-150, FORD F-250 & F-250, FORD F-350 & F-350, FORD RANGER, FORD
          LIGHTNING, FORD MAVERICK, SUPERCREW, SUPERCAB, POWER STROKE, TRITON V8, ECOBOOST,
          SUPERDUTY, & TREMOR ARE REGISTERED TRADEMARKS OF THE FORD MOTOR COMPANY. COLORADO, Z71,
          ZR2, TRAIL BOSS, DURAMAX, CHEVROLET, GMC, CHEVROLET SILVERADO, CHEVROLET TAHOE, GMC
          SIERRA, GMC CANYON, SILVERADO, SIERRA, DENALI, VORTEC LS V8, DURAMAX, LTZ, SILVERADO LT,
          SILVERADO HD, SIERRA ALL TERRAIN X, ECOTEC3, Z-71, SILVERADO 1500, SILVERADO SS, YUKON,
          AT4, AT4X, SLE, AND SLT ARE REGISTERED TRADEMARKS OF GENERAL MOTORS COMPANY (GM). DODGE,
          DODGE RAM, RAM TRUCKS, RAM 1500, RAM 2500, RAM 3500, DAKOTA, SRT/10, 1500 SLT PLUS, 1500
          SLT, ST, LARAMIE, DAYTONA, MEGA CAB, SLT/SPORT/TRX, SLT/TRX, LE, SE, SHELBY, S, WS,
          SXT, TRX4, BIG HORN, LONE STAR, R/T, SPORT, LARAMIE LONGHORN, TRADESMAN HEAVY DUTY,
          TRADESMAN/EXPRESS, TRADESMAN, HFE, REBEL, LONGHORN ARE REGISTERED TRADEMARKS OF FIAT
          CHRYSLER AUTOMOBILES (FCA). ALLISON TRANSMISSION IS A REGISTERED TRADEMARK OF ALLISON
          TRANSMISSION, INC. CUMMINS IS A REGISTERED TRADEMARK OF CUMMINS INC. SALEEN IS A
          REGISTERED TRADEMARK OF SALEEN INCORPORATED. ROUSH IS A REGISTERED TRADEMARK OF ROUSH
          ENTERPRISES, INC. AMERICANTRUCKS HAS NO AFFILIATION WITH THE FORD MOTOR COMPANY, CUMMINS,
          INC., ALLISON TRANSMISSION, INC., ROUSH ENTERPRISES, SALEEN, THE GENERAL MOTORS COMPANY
