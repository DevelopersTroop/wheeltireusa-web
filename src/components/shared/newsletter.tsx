...
// import Newsletter from '../header/_components/newsletter/newsletter';
...
export const FooterNewsletter = () => {
    ...
    return (
        <div>
            ...
            className={'bg-primary px-6 py-2.5 font-semibold rounded-[4px] h-14 flex items-center gap-2 hover:bg-red-700 transition duration-300 ease-in-out'}>
