...
function TabsTriggerMainFilter({
  className,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.Trigger>) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'border-b-3 border-transparent px-2 py-1 text-base font-medium',
        'whitespace-nowrap transition-[color,box-shadow]',
        'text-foreground dark:text-muted-foreground mt-3.5 pb-4 cursor-pointer',
...
export { Tabs, TabsList, TabsTrigger, TabsContent, TabsTriggerMainFilter };
