 ...
 * Get Sub Models
 */
const getSubModels = async (year: string, make: string, model: string, bodyType: string, _regionId = "1"): Promise<{ SubModel: string, DRChassisID: string, DRModelID: string }[]> => {
...
export { getBodyTypes, getDRDChassisReturn_NA, getMakes, getModels, getRegions, getSubModels, getUpStepWheels, getVehicleData, getYears };
